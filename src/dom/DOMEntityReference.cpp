...
class DOMEntityReferenceWrapper
: public xercesc::DOMEntityReference, public boost::python::wrapper<xercesc::DOMEntityReference>
{
public:
//! ---------- DOMNode ----------
...
void DOMEntityReference_init(void) {
	...
	boost::python::class_<DOMEntityReferenceWrapper, boost::noncopyable, boost::python::bases<xercesc::DOMNode> >("DOMEntityReference");
}
