...
class DOMCommentWrapper
: public xercesc::DOMComment, public boost::python::wrapper<xercesc::DOMComment>
{
public:
//! ---------- DOMCharacterData ----------
...
void DOMComment_init(void) {
	//! xercesc::DOMComment
	boost::python::class_<DOMCommentWrapper, boost::noncopyable, boost::python::bases<xercesc::DOMCharacterData> >("DOMComment");
}
