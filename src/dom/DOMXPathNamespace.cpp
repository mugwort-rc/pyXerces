...
class DOMXPathNamespaceWrapper
: public xercesc::DOMXPathNamespace, public boost::python::wrapper<xercesc::DOMXPathNamespace>
{
public:
...
void DOMXPathNamespace_init(void) {
	...
	auto DOMXPathNamespace = boost::python::class_<DOMXPathNamespaceWrapper, boost::noncopyable, boost::python::bases<xercesc::DOMNode> >("DOMXPathNamespace")
			.def("getOwnerElement", boost::python::pure_virtual(&xercesc::DOMXPathNamespace::getOwnerElement), boost::python::return_value_policy<boost::python::reference_existing_object>())
			;
