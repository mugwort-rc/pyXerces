...
class DOMTextWrapper
: public xercesc::DOMText, public boost::python::wrapper<xercesc::DOMText>
{
public:
...
void DOMText_init(void) {
	...
	boost::python::class_<DOMTextWrapper, boost::noncopyable, boost::python::bases<xercesc::DOMCharacterData> >("DOMText")
			...
			.def("replaceWholeText", boost::python::pure_virtual(&xercesc::DOMText::replaceWholeText), boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("isIgnorableWhitespace", boost::python::pure_virtual(&xercesc::DOMText::isIgnorableWhitespace))
			;
}
