...
class DOMDocumentTypeWrapper
: public xercesc::DOMDocumentType, public boost::python::wrapper<xercesc::DOMDocumentType>
{
public:
...
xercesc::DOMNamedNodeMap *getEntities() const {
	return this->get_override("getEntities")();
}

xercesc::DOMNamedNodeMap *getNotations() const {
	return this->get_override("getNotations")();
}
...
const XMLCh* getInternalSubset() const {
	return this->get_override("getInternalSubset")();
}
...
void DOMDocumentType_init(void) {
	...
	boost::python::class_<DOMDocumentTypeWrapper, boost::noncopyable, boost::python::bases<xercesc::DOMNode> >("DOMDocumentType")
			.def("getName", boost::python::pure_virtual(&xercesc::DOMDocumentType::getName), boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getEntities", boost::python::pure_virtual(&xercesc::DOMDocumentType::getEntities), boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("getNotations", boost::python::pure_virtual(&xercesc::DOMDocumentType::getNotations), boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("getPublicId", boost::python::pure_virtual(&xercesc::DOMDocumentType::getPublicId), boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getSystemId", boost::python::pure_virtual(&xercesc::DOMDocumentType::getSystemId), boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getInternalSubset", boost::python::pure_virtual(&xercesc::DOMDocumentType::getInternalSubset), boost::python::return_value_policy<boost::python::return_by_value>())
			;
}
