...
class DOMNotationWrapper
: public xercesc::DOMNotation, public boost::python::wrapper<xercesc::DOMNotation>
{
public:
...
void DOMNotation_init(void) {
	//! xercesc::DOMNotation
	boost::python::class_<DOMNotationWrapper, boost::noncopyable, boost::python::bases<xercesc::DOMNode> >("DOMNotation")
			.def("getPublicId", boost::python::pure_virtual(&xercesc::DOMNotation::getPublicId), boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getSystemId", boost::python::pure_virtual(&xercesc::DOMNotation::getSystemId), boost::python::return_value_policy<boost::python::return_by_value>())
			;
}
