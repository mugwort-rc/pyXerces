...
template <class STR>
xercesc::DTDElementDecl* DTDElementDecl_init(const STR& elemRawName, const unsigned int uriId, const xercesc::DTDElementDecl::ModelTypes modelType, xercesc::MemoryManager* const manager) {
	XMLString buff(elemRawName);
	return new xercesc::DTDElementDecl(buff.ptr(), uriId, modelType, manager);
}

template <class STR>
xercesc::DTDElementDecl* DTDElementDecl_init(const STR& elemRawName, const unsigned int uriId, const xercesc::DTDElementDecl::ModelTypes modelType) {
	return DTDElementDecl_init<STR>(elemRawName, uriId, modelType, xercesc::XMLPlatformUtils::fgMemoryManager);
}
...
void DTDElementDecl_init(void) {
	...
	boost::python::class_<xercesc::DTDElementDecl, boost::noncopyable, boost::python::bases<xercesc::XMLElementDecl> >("DTDElementDecl", boost::python::init<boost::python::optional<xercesc::MemoryManager* const> >())
			...
			.def("__init__", boost::python::make_constructor(static_cast<xercesc::DTDElementDecl*(*)(const XMLString&, const unsigned int, const xercesc::DTDElementDecl::ModelTypes, xercesc::MemoryManager* const)>(&DTDElementDecl_init<XMLString>)))
			.def("__init__", boost::python::make_constructor(static_cast<xercesc::DTDElementDecl*(*)(const XMLString&, const unsigned int, const xercesc::DTDElementDecl::ModelTypes)>(&DTDElementDecl_init<XMLString>)))
			.def("__init__", boost::python::make_constructor(static_cast<xercesc::DTDElementDecl*(*)(const std::string&, const unsigned int, const xercesc::DTDElementDecl::ModelTypes, xercesc::MemoryManager* const)>(&DTDElementDecl_init<std::string>)))
			.def("__init__", boost::python::make_constructor(static_cast<xercesc::DTDElementDecl*(*)(const std::string&, const unsigned int, const xercesc::DTDElementDecl::ModelTypes)>(&DTDElementDecl_init<std::string>)))
			.def(DTDElementDeclDefVisitor<XMLString>())
			.def(DTDElementDeclDefVisitor<std::string>())
