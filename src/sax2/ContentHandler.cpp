...
void ContentHandler_init(void) {
	...
	boost::python::class_<ContentHandlerWrapper, boost::noncopyable>("ContentHandler")
			...
			.def("characters", &xercesc::ContentHandler::characters)
			.def("endDocument", &xercesc::ContentHandler::endDocument)
			.def("endElement", &xercesc::ContentHandler::endElement)
			.def("ignorableWhitespace", &xercesc::ContentHandler::ignorableWhitespace)
			.def("processingInstruction", &xercesc::ContentHandler::processingInstruction)
			.def("setDocumentLocator", &xercesc::ContentHandler::setDocumentLocator)
			.def("startDocument", &xercesc::ContentHandler::startDocument)
			.def("startElement", &xercesc::ContentHandler::startElement)
			.def("startPrefixMapping", &xercesc::ContentHandler::startPrefixMapping)
			.def("endPrefixMapping", &xercesc::ContentHandler::endPrefixMapping)
			.def("skippedEntity", &xercesc::ContentHandler::skippedEntity)
			;
}
