...
void Attributes_init(void) {
	...
	boost::python::class_<AttributesWrapper, boost::noncopyable>("Attributes")
			...
			.def(AttributesDefVisitor<std::string>())
			.def("getLength", &xercesc::Attributes::getLength)
			.def("getURI", &xercesc::Attributes::getURI, boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getLocalName", &xercesc::Attributes::getLocalName, boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getQName", &xercesc::Attributes::getQName, boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getType", static_cast<const XMLCh*(xercesc::Attributes::*)(const XMLSize_t) const>(&xercesc::Attributes::getType), boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getValue", static_cast<const XMLCh*(xercesc::Attributes::*)(const XMLSize_t) const>(&xercesc::Attributes::getValue), boost::python::return_value_policy<boost::python::return_by_value>())
			...
			//.def("getIndex", static_cast<int(xercesc::Attributes::*)(const XMLCh* const, const XMLCh* const) const>(&xercesc::Attributes::getIndex))
			...
			.def("getType", static_cast<const XMLCh*(xercesc::Attributes::*)(const XMLCh* const, const XMLCh* const) const>(&xercesc::Attributes::getType), boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getType", static_cast<const XMLCh*(xercesc::Attributes::*)(const XMLCh* const) const>(&xercesc::Attributes::getType), boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getValue", static_cast<const XMLCh*(xercesc::Attributes::*)(const XMLCh* const, const XMLCh* const) const>(&xercesc::Attributes::getValue), boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getValue", static_cast<const XMLCh*(xercesc::Attributes::*)(const XMLCh* const) const>(&xercesc::Attributes::getValue), boost::python::return_value_policy<boost::python::return_by_value>())
			;
}
