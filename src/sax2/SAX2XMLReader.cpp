...
void SAX2XMLReader_init(void) {
	...
	auto SAX2XMLReader = boost::python::class_<SAX2XMLReaderWrapper, boost::noncopyable>("SAX2XMLReader")
			...
			.def("getContentHandler", &xercesc::SAX2XMLReader::getContentHandler, boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("getDTDHandler", &xercesc::SAX2XMLReader::getDTDHandler, boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("getEntityResolver", &xercesc::SAX2XMLReader::getEntityResolver, boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("getErrorHandler", &xercesc::SAX2XMLReader::getErrorHandler, boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("getFeature", &xercesc::SAX2XMLReader::getFeature)
			.def("getProperty", &xercesc::SAX2XMLReader::getProperty, boost::python::return_value_policy<boost::python::return_opaque_pointer>())
			.def("setContentHandler", &xercesc::SAX2XMLReader::setContentHandler)
			.def("setDTDHandler", &xercesc::SAX2XMLReader::setDTDHandler)
			.def("setEntityResolver", &xercesc::SAX2XMLReader::setEntityResolver)
			.def("setErrorHandler", &xercesc::SAX2XMLReader::setErrorHandler)
			.def("setFeature", &xercesc::SAX2XMLReader::setFeature)
			.def("setProperty", &xercesc::SAX2XMLReader::setProperty)
			.def("parse", static_cast<void(xercesc::SAX2XMLReader::*)(const xercesc::InputSource&)>(&xercesc::SAX2XMLReader::parse))
			.def("parse", static_cast<void(xercesc::SAX2XMLReader::*)(const XMLCh* const)>(&xercesc::SAX2XMLReader::parse))
			.def("parse", static_cast<void(xercesc::SAX2XMLReader::*)(const char* const)>(&xercesc::SAX2XMLReader::parse))
			.def("getDeclarationHandler", &xercesc::SAX2XMLReader::getDeclarationHandler, boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("getLexicalHandler", &xercesc::SAX2XMLReader::getLexicalHandler, boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("setDeclarationHandler", &xercesc::SAX2XMLReader::setDeclarationHandler)
			.def("setLexicalHandler", &xercesc::SAX2XMLReader::setLexicalHandler)
			.def("getValidator", &xercesc::SAX2XMLReader::getValidator, boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("getErrorCount", &xercesc::SAX2XMLReader::getErrorCount)
			.def("getExitOnFirstFatalError", &xercesc::SAX2XMLReader::getExitOnFirstFatalError)
			.def("getValidationConstraintFatal", &xercesc::SAX2XMLReader::getValidationConstraintFatal)
			.def("getGrammar", &xercesc::SAX2XMLReader::getGrammar, boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("getRootGrammar", &xercesc::SAX2XMLReader::getRootGrammar, boost::python::return_value_policy<boost::python::reference_existing_object>())
			.def("getURIText", &xercesc::SAX2XMLReader::getURIText, boost::python::return_value_policy<boost::python::return_by_value>())
			.def("getSrcOffset", &xercesc::SAX2XMLReader::getSrcOffset)
			.def("setValidator", &xercesc::SAX2XMLReader::setValidator)
			.def("setExitOnFirstFatalError", &xercesc::SAX2XMLReader::setExitOnFirstFatalError)
			.def("setValidationConstraintFatal", &xercesc::SAX2XMLReader::setValidationConstraintFatal)
			.def("parseFirst", static_cast<bool(xercesc::SAX2XMLReader::*)(const XMLCh* const, xercesc::XMLPScanToken&)>(&xercesc::SAX2XMLReader::parseFirst))
			.def("parseFirst", static_cast<bool(xercesc::SAX2XMLReader::*)(const char* const, xercesc::XMLPScanToken&)>(&xercesc::SAX2XMLReader::parseFirst))
			.def("parseFirst", static_cast<bool(xercesc::SAX2XMLReader::*)(const xercesc::InputSource&, xercesc::XMLPScanToken&)>(&xercesc::SAX2XMLReader::parseFirst))
			.def("parseNext", &xercesc::SAX2XMLReader::parseNext)
			.def("parseReset", &xercesc::SAX2XMLReader::parseReset)
			.def("loadGrammar", static_cast<xercesc::Grammar*(xercesc::SAX2XMLReader::*)(const xercesc::InputSource&, const xercesc::Grammar::GrammarType, const bool)>(&xercesc::SAX2XMLReader::loadGrammar), SAX2XMLReaderLoadGrammarOverloads()[boost::python::return_value_policy<boost::python::reference_existing_object>()])
			.def("loadGrammar", static_cast<xercesc::Grammar*(xercesc::SAX2XMLReader::*)(const XMLCh* const, const xercesc::Grammar::GrammarType, const bool)>(&xercesc::SAX2XMLReader::loadGrammar), SAX2XMLReaderLoadGrammarOverloads()[boost::python::return_value_policy<boost::python::reference_existing_object>()])
			.def("loadGrammar", static_cast<xercesc::Grammar*(xercesc::SAX2XMLReader::*)(const char* const, const xercesc::Grammar::GrammarType, const bool)>(&xercesc::SAX2XMLReader::loadGrammar), SAX2XMLReaderLoadGrammarOverloads()[boost::python::return_value_policy<boost::python::reference_existing_object>()])
			.def("resetCachedGrammarPool", &xercesc::SAX2XMLReader::resetCachedGrammarPool)
			.def("setInputBufferSize", &xercesc::SAX2XMLReader::setInputBufferSize)
			.def("installAdvDocHandler", &xercesc::SAX2XMLReader::installAdvDocHandler)
			.def("removeAdvDocHandler", &xercesc::SAX2XMLReader::removeAdvDocHandler)
			;
