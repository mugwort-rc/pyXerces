...
void PlatformUtils_init(void) {
	...
	boost::python::class_<xercesc::XMLPlatformUtils, boost::noncopyable>("XMLPlatformUtils", boost::python::no_init)
			...
			.def_readonly("fgNetAccessor", &xercesc::XMLPlatformUtils::fgNetAccessor)
			.def_readonly("fgTransService", &xercesc::XMLPlatformUtils::fgTransService)
			.def_readonly("fgUserPanicHandler", &xercesc::XMLPlatformUtils::fgUserPanicHandler)
			.def_readonly("fgDefaultPanicHandler", &xercesc::XMLPlatformUtils::fgDefaultPanicHandler)
			.def_readonly("fgMemoryManager", &xercesc::XMLPlatformUtils::fgMemoryManager)
			.def_readonly("fgFileMgr", &xercesc::XMLPlatformUtils::fgFileMgr)
			.def_readonly("fgMutexMgr", &xercesc::XMLPlatformUtils::fgMutexMgr)
			.def_readonly("fgAtomicMutex", &xercesc::XMLPlatformUtils::fgAtomicMutex)
			.def_readonly("fgXMLChBigEndian", &xercesc::XMLPlatformUtils::fgXMLChBigEndian)
			.def_readonly("fgSSE2ok", &xercesc::XMLPlatformUtils::fgSSE2ok)
			;
}
