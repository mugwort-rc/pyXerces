...
void visit(T& class_) const {
	class_
	.def("itemByName", &XSNamedMapDefVisitor<TVal, STR>::itemByName, boost::python::return_value_policy<boost::python::reference_existing_object>())
	.def("addElement", &XSNamedMapDefVisitor<TVal, STR>::addElement)
	;
}
