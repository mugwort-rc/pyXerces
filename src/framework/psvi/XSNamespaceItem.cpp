...
template <class STR>
xercesc::XSNamespaceItem* XSNamespaceItem_fromstring(xercesc::XSModel* const xsModel, const STR& schemaNamespace, xercesc::MemoryManager* const manager) {
	XMLString buff(schemaNamespace);
	return new xercesc::XSNamespaceItem(xsModel, buff.ptr(), manager);
}

template <class STR>
xercesc::XSNamespaceItem* XSNamespaceItem_fromstring(xercesc::XSModel* const xsModel, const STR& schemaNamespace) {
	return XSNamespaceItem_fromstring<STR>(xsModel, schemaNamespace, xercesc::XMLPlatformUtils::fgMemoryManager);
}
...
void XSNamespaceItem_init(void) {
	...
	boost::python::class_<xercesc::XSNamespaceItem, boost::noncopyable>("XSNamespaceItem", boost::python::init<xercesc::XSModel* const, xercesc::SchemaGrammar* const, boost::python::optional<xercesc::MemoryManager* const> >())
			...
			.def("__init__", boost::python::make_constructor(static_cast<xercesc::XSNamespaceItem*(*)(xercesc::XSModel* const, const XMLString&, xercesc::MemoryManager* const)>(&XSNamespaceItem_fromstring<XMLString>)))
			.def("__init__", boost::python::make_constructor(static_cast<xercesc::XSNamespaceItem*(*)(xercesc::XSModel* const, const XMLString&)>(&XSNamespaceItem_fromstring<XMLString>)))
			.def("__init__", boost::python::make_constructor(static_cast<xercesc::XSNamespaceItem*(*)(xercesc::XSModel* const, const std::string&, xercesc::MemoryManager* const)>(&XSNamespaceItem_fromstring<std::string>)))
			.def("__init__", boost::python::make_constructor(static_cast<xercesc::XSNamespaceItem*(*)(xercesc::XSModel* const, const std::string&)>(&XSNamespaceItem_fromstring<std::string>)))
			.def(XSNamespaceItemDefVisitor())
			.def(XSNamespaceItemStringDefVisitor<XMLString>())
			.def(XSNamespaceItemStringDefVisitor<std::string>())
